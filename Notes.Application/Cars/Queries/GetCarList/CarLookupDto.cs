    ...
    public class CarLookupDto : IMapWith<Car>
    {
        ...
        public void Mapping(Profile profile)
        {
            profile.CreateMap<Car, CarLookupDto>()
                ...
                .ForMember(dto => dto.Color, opt => opt.MapFrom(car => car.CarColor.Name))
                .ForMember(dto => dto.Box, opt => opt.MapFrom(car => car.Box.Name))
                .ForMember(dto => dto.SteeringWheel, opt => opt.MapFrom(car => car.SteeringWheel.Name))
                .ForMember(dto => dto.Body, opt => opt.MapFrom(car => car.Body.Name))
